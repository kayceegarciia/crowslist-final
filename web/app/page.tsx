...
const faqs: { title: string; description: string }[] = [
  {
    title: "What does Crowslist offer to students?",
    description:
      "Crowslist provides a dedicated online marketplace where students can buy and sell used college essentials like textbooks, dorm supplies, stationery, and more. This platform helps students save money while promoting the reuse of valuable resources.",
  },
  {
    title: "How does Crowslist promote sustainability?",
    description:
      "By encouraging students to buy and sell used items, Crowslist helps reduce waste and the demand for new products. This promotes a culture of recycling and sustainability, contributing to a greener college experience.",
  },
  {
  ...
  {
    title: "How does Crowslist ensure moderation for listings?",
    description:
      "Crowslist employs admin moderation to review and approve listings before they go live. This process ensures that items meet the platform’s guidelines.",
  },
  {
    title: "Can admin remove inappropriate listings or content?",
    description:
      "Yes, admins have the authority to remove any listings or content that violate Crowslist’s terms of service. This includes items that are inappropriate, prohibited, or misrepresent their condition.",
  },
  {
    title: "Does Crowslist offer real-time chat for buyers and sellers?",
    description:
      "Yes, Crowslist provides a built-in real-time chat feature that allows buyers and sellers to communicate directly. This enables quick negotiations and inquiries.",
  },
  {
  ...
  {
    title: "How are delivery details arranged on Crowslist?",
    description:
  ...
  {
    title: "Does Crowslist provide any delivery services?",
    description:
      "No, Crowslist does not offer delivery services. The buyer and seller must discuss and agree on the mode of delivery via the platform’s real-time chat feature, ensuring flexibility based on their preferences.",
  },
];
          ...
          <div className="p-5 max-w-5xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="space-y-3">
              <h1 className="text-6xl font-extrabold">
                ...
                Resources Within <span className="text-secondary">ASU</span>
              </h1>
              <p className="text-lg">
